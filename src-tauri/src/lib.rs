        ...
        .setup(|app| {
            ...
            *state.path.lock().unwrap() = load_download_path(app.handle());
            ...
            #[cfg(desktop)]
            {
                ...
                let _ = app.global_shortcut().on_shortcut("MediaPlayPause", |app: &AppHandle, _shortcut, _event| {
            ...
            #[cfg(desktop)]
            {
                window_builder = window_builder.title("Monochrome").inner_size(1200.0, 800.0);
            }
